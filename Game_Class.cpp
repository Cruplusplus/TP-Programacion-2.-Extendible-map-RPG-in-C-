...
void Juego::initWindow()
{
   ...
   this->window = std::make_unique<sf::RenderWindow>( ///CREA UNA VENTANA Y LA LIBERA AL CERRAR EL JUEGO
...
{
    this->jugador = std::make_unique<Jugador>(); ///CREA UN JUGADOR EN MEMORIA DINAMICA SIN NECESIDAD DEL DELETE
    this->enemigo = std::make_unique<Enemigo>(1, 5, 1, 1, 3, "Slime");
}
...
Juego::~Juego() = default; ///SE DESTRUYE AUTOMATICAMENTE
